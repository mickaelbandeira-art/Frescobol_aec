  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl h-full flex flex-col justify-center py-4">
        ...
        <div className={`grid ${filteredProducts.length === 1 ? 'grid-cols-1 place-items-center max-w-[280px] mx-auto' : 'grid-cols-2 sm:grid-cols-3'} gap-2.5 md:gap-6 max-h-[55vh] md:max-h-[60vh] overflow-y-auto custom-scrollbar px-2 py-2`}>
